	...
	<div id="total">
		...
		<div id="main">
			<div class="ingu">
				<div id="headTitle">
					<h4>
						<a id="title">아파트 장터 </a><span id="title1">물건을 사고팔수 있는 공간입니다.</span>
					</h4>
				</div>
				...
				<div>
					<img class="images1" src="resources/board/images/marketBoard.jpg"
						width="100%" height="100%">
				</div>

				<div class="list_category ">
					<span class="category_item"><a href="marketList.do"
						class="current">전체보기</a></span> <span class="category_item"><a
						href="marketList.do?b_category=팝니다">팝니다</a></span> <span
						class="category_item"><a
						href="marketList.do?b_category=삽니다">삽니다</a></span>

				</div>
				<div class="thumbnailArea">
					<c:forEach var="b" items="${ maList }">
						<c:url var="maDetail" value="maDetail.do">
						...
						<div class="thumb-list">
							<div>
								<!-- <img id="marketImg" src="" width="200px" height="150px"> -->
								<img  id="marketImg"
									src="${contextPath}/resources/buploadFiles/${b.rename_filename }"
									width="200px" height="150px">
							</div>

							<p>
								<a href="${maDetail}">${b.b_title }</a>
							</p>
							<p>${b.m_id}</p>
							<p>${b.b_create_date  }</p>
							<p>${b.b_category}</p>
				...
				<div id="line_foot">
					<div id="searchArea" style="text-align: left;">
						<form action="maSearch.do" name="searchForm" method="get">
					...
					<div id="paignArea" style="text-align: center;">
						<tr align="center" height="20">
							<c:if test="${searchValue eq null }">
								<c:set var="loc" value="marketList.do" />
							</c:if>
							<c:if test="${searchValue ne null }">
								<c:set var="loc" value="maSearch.do" />
							</c:if>
							...
							<td colspan="6"><c:if test="${pi.currentPage == 1 }">
								...
								</c:forEach> <c:if test="${pi.currentPage == pi.maxPage}">
										[다음]
					...
					<!-- <div id="insert" style="text-align:right;">
							<button type="button" onclick="location.href='binsertView.do';">글쓰기</button>
						</div> -->
					<div id="insert" style="text-align: right;">
