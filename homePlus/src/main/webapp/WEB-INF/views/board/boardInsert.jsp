...
<body>
   ...
   <form action="binsert.do" method="POST" encType="Multipart/form-data" onsubmit="return Validate();">
      <div id="total">
         <!-- SIDE-BAR -->
         <div id="side-bar">
         <ul>
         ...
         <div id="main">
            <div class="ingu">
               <div id="line">
                  <div id="headTitle">
                     <h4>
                        <a id="title">게시글 작성 </a><span id="title1">아파트 입주자
                           소모임입니다.</span>
                     </h4>
                  </div>
                  ...
                  <div id="board-title">
                     <input type="text" class="input-title" id="subject"
                        placeholder="제목을 입력하세요." name="b_title" style="width: 97%;">
                  </div>
               ...
               <div id="line2">
                        ...
                        <select style="width: 90%" id="insertboard" name="b_name"
                          ...
                          <c:if test="${ loginUser.mId eq 'master' }">  
                           ...
                           <option value="아파트장터">아파트 장터</option>
                            ...
                            <c:if test="${ loginUser.mId ne 'master' }">
                           <option value="——">——</option>
                           <option value="커뮤니티">커뮤니티</option>
                           <option value="아파트장터">아파트 장터</option>
                           </c:if>
                  ...
                  <div id="info-line2">
                     ...
                     <div>
                        ...
                        <div id="insertFile">
                           <span>파일첨부</span> <input type="file" name="uploadFile">
                        </div>
