	...
	<div id="total">
		...
		<div id="main">
			<div class="ingu">
				...
				<div id="headTitle">
					<h4>
						<a id="title">커뮤니티 게시판 </a><span id="title1">아파트 입주자
							소모임입니다.</span>
					</h4>
				</div>
				...
				<div class="images1">
					<img src="resources/board/images/communityBoard.jpg" width="100%"
						height="100%">
				</div>

				<div class="list_category ">
					<span class="category_item"><a href="boardList.do"
						class="current">전체보기</a></span> <span class="category_item"><a
						href="boardList.do?b_category=잡담">잡담</a></span> <span
						class="category_item"><a href="boardList.do?b_category=후기">후기</a></span>
					<span class="category_item"><a
						href="boardList.do?b_category=정보">정보</a></span> <span
						class="category_item"><a href="boardList.do?b_category=질문">질문</a></span>
				</div>
				...
				<div class="boardArea">
					<table class="sub_news" border="1">
						...
						<tbody>
							<c:forEach var="b" items="${ commList }">
								<c:url var="commDetail" value="communityDetail.do">
								...
								<tr>
									<td>${b.b_code }</td>
									<td>${b.b_category }</td>
									<td><a href="${commDetail}">${b.b_title}</a></td>
									<td>${b.m_id }</td>
					...
					<div id="line_foot">
						...
						<div id="searchArea" style="text-align: left;">
							<form action="cmmSearch.do" name="searchForm" method="post">
						...
						<div id="paignArea" style="text-align: center;">
							<tr align="center" height="20">
								<c:if test="${searchValue eq null }">
									<c:set var="loc" value="boardList.do" />
								</c:if>
								<c:if test="${searchValue ne null }">
									<c:set var="loc" value="cmmSearch.do" />
								</c:if>
            ...
            [이전]
										...
										<c:if test="${pi.currentPage == i}">[${i }]</c:if>
										...
										<c:when test="${pi.currentPage gt pi.maxPage}">[다음]</c:when>
